...
class OllamaClient:
    ...
    def interpret_mineru_context(self, context_label: str, context_text: str, source_name: str, ontology_categories: list[str]) -> dict[str, Any] | None:
        ...
        prompt = (
            ...
            "Do not invent values unsupported by the context.\n\n"
